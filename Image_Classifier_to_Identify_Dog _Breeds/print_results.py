...
#                                                                             
# PROGRAMMER: Kemal Utku Mutlu
# DATE CREATED: 14.03.2024
# REVISED DATE: 15.03.2024
...
def print_results(results_dic, results_stats_dic, model, 
    ...
    if print_incorrect_dogs and (
        ...
        for key in results_dic:
            # Pet label is a dog and classifier label is not-a-dog OR
            # Pet label is not-a-dog and classifier label is a dog
            if sum(results_dic[key][3:]) == 1:
                print("Filename:", key, "    Pet Label:", results_dic[key][0], "    Classifier Label:",results_dic[key][1])

    # IF print_incorrect_breed is True AND there were dogs whose breeds were incorrectly classified
    if print_incorrect_breed and (results_stats_dic['n_correct_dogs'] != results_stats_dic['n_correct_breed']):
        print("\nINCORRECT Dog Breed Assignment:")
        for key in results_dic:
            # Pet image label is a dog, classifier label is a dog, but breeds do not match
