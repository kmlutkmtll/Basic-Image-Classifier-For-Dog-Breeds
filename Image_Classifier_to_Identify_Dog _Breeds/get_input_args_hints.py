...
def get_input_args():
    ...
    parser.add_argument('--arch',type = str, default = 'vgg' ,help = "select CNN model architecture: "
                                                                     "vgg, alexnet, or resnet")
    parser.add_argument('--dogfile',type = str, default = 'dognames.txt' ,help = "path to the file that contains "
                                                                                 "the list of dog names")
